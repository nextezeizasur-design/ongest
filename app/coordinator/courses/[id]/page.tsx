        ...
        {activeTab === 'students' && (
          <div className="card p-0 overflow-hidden">
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
              ...
              <Link href="/secretary/students" className="text-xs font-medium" style={{ color: '#642f8d' }}>Gestionar →</Link>
            </div>
            {students.length === 0 ? (
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden">
      <TopBar
        ...
        subtitle={cefrLevel ? `${cefrLevel.label} · ${cefrLevel.code}` : 'Sin nivel'}
        actions={
          <a href={profile.role === 'director' ? '/director/courses' : '/coordinator/courses'} className="btn-outline text-sm">← Volver</a>
        }
      />
      ...
      <main className="flex-1 overflow-y-auto p-6 space-y-5">
        ...
        <div className="card p-0 overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
            ...
            <a href="/secretary/students" className="text-xs font-medium" style={{ color: '#642f8d' }}>Gestionar →</a>
          </div>
          {students.length === 0 ? (
            <div className="py-12 text-center text-sm text-gray-400">No hay alumnos inscriptos.</div>
          ) : (
