...
export default function DirectorStudentsClient({ orgId }: { orgId: string }) {
  ...
  return (
    <div className="space-y-5">
                    ...
                    <td>
                      <div className="flex gap-3 items-center">
                        ...
                        <button
                          ...
                          title="Reenviar credenciales o cambiar la contraseña temporal"
                        >
                          🔑 Credenciales
                        </button>
                        <button
            ...
            {filtered.map(s => {
              ...
              return (
                <div key={s.id} className={`card-sm ${!s.is_active ? 'opacity-50' : ''}`}>
                  ...
                  {/* Acciones */}
                  <div className="flex gap-4 items-center mt-4 pt-3 border-t border-gray-100 flex-wrap">
                    <button
                      onClick={() => openEdit(s)}
      ...
      {/* Modal credenciales — reenviar / cambiar contraseña temporal */}
      {credModal && (
