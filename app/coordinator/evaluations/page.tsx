...
export default function NewEvaluationPage() {
  ...
  function handleAddImported() {
    ...
    const drafted: QuestionDraft[] = toAdd.map(q => {
      // Construir el body final: consigna arriba + enunciado del ítem abajo
                ...
                {importedQs !== null && (
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-gray-400">{importCheckedCount} seleccionadas · La consigna se incluye en cada pregunta</span>
                    </div>
                        ...
                        <div key={q.id}
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {q.instruction && (
                                <div className="mt-2 bg-purple-50 border border-purple-100 rounded-lg px-2.5 py-2">
                                  <p className="text-[10px] font-semibold text-purple-600 uppercase tracking-wide mb-0.5">Consigna</p>
